//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (42d8fc22) on 2021-06-05 19:40:17
//--------------------------------------------------------------------------------
module liteeth_core_tx(
...
assign arp_tx_packetizer_sink_param_sender_mac = 48'd186934156596023;
assign arp_tx_packetizer_sink_param_sender_ip = 32'd3232281089;
always @(*) begin
...
always @(*) begin
	...
	case (subfragments_liteetharptx_fsm_state)
		1'd1: begin
			...
			arp_tx_source_source_payload_sender_mac <= 48'd186934156596023;
...
assign ip_tx_packetizer_sink_param_sender_ip = 32'd3232281089;
...
always @(*) begin
	...
	case (subfragments_liteethip_liteethiptx_fsm_state)
		...
		2'd3: begin
			...
			ip_tx_source_source_payload_sender_mac <= 48'd186934156596023;
...
always @(posedge sys_clk) begin
	...
	arp_rx_valid <= (((((arp_rx_depacketizer_source_valid & (arp_rx_depacketizer_source_param_hwtype == 1'd1)) & (arp_rx_depacketizer_source_param_proto == 12'd2048)) & (arp_rx_depacketizer_source_param_hwsize == 3'd6)) & (arp_rx_depacketizer_source_param_protosize == 3'd4)) & (arp_rx_depacketizer_source_param_target_ip == 32'd3232281089));
	...
	ip_rx_valid <= ((((ip_rx_depacketizer_source_valid & (ip_rx_depacketizer_source_param_target_ip == 32'd3232281089)) & (ip_rx_depacketizer_source_param_version == 3'd4)) & (ip_rx_depacketizer_source_param_ihl == 3'd5)) & (ip_rx_liteethipv4checksum_value == 1'd0));
